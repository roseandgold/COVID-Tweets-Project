# Twitter API script
# Takes a CSV of Tweet ids, accesses the Twitter API to get the Tweet text, and returns a CSV with the date, text, location, language, hashtags and sentiment score.
